...
<head>
	...
	<style type="text/css">
		...
		.reset-div-box  {background: #FFF;position: absolute;top: 15%;left: 50%;margin: 0 0 0 -300px;padding: 0 68px;width: 500px;height: 400px;}
...
<div class="left-rail content-wrap">
	<div class="content student-page">
		...
		<div  class="reset-div-box corners" >
			...
			<form id="reset" action="<core:url value="/password/reset.html"/>" method="POST">
				<table width="100%">
				<tr>
				<td colspan="2">
				...
				<footer class="form-action clearfix">
					...
					<div class="action plain-button">
						<div class="bw">
							<input type="submit" class="button" name="submit" value="Reset">	
						</div>
					</div>
		...
		<% } else { %>
		<div id="reset-div-box" class="reset-div-box">
			<div style="position: relative;top: 20px;width: 100%;padding: 10px;">
			<header class="header">
				<h4>Reset Password</h4>
			</header>
