...
<head>
	<core:choose>
		<core:when test="${param.feeOption=='Scheduling'}">
	...
	<style type="text/css">
		...
		.login  {background: #FFF;position: absolute;top: 50px;left: 50%;margin: 0 0 0 -300px;padding: 0 68px;width: 500px;min-height: 350px;}
	...
	<div class="content student-page">
		...
		<div class="login corners" >
			...
			<header class="header" style="text-align:center;">
				<core:choose>
					<core:when test="${param.feeOption=='Scheduling'}">
						<h4>Please sign in to schedule classes, mark complete and print certificates.</h4>
					</core:when>
					<core:otherwise>
						<h4>Please sign in to enter or edit course records.</h4>
					</core:otherwise>
				</core:choose>
				
				<span>Use your existing Learning Center (LMS) username and password.</span>
			</header>
			</td></tr></table>
			</div>
			<div style="width:400px; margin-left:auto; margin-right:auto;">
			<form:form method="POST" commandName="credentials">
				...
				<tr>
				<td>
					<label for="username" class="asterisk">Username:</label>
				</td>
				<td>
				...
				<tr>
				<td colspan="2">
					<form:errors path="username"  cssClass="msgError" />				
				</td>
				</tr>	
				<tr>
				<td>
					<label for="password" class="asterisk">Password:</label>
				</td>
				<td>
				...
				<tr>
				<td></td><td><a href="<core:url value="/password/reset.html"/>" tabindex="-1">Forgot Password?</a></td>
				</tr>
				<tr>
				<td colspan="2">
					<form:errors path="password"   cssClass="msgError" />				
				</td>
				</tr>
				<tr>
				<td colspan="2">
		...
		<div style="position:relative; color:#900000; text-align:center; width:350px; top: 400px; padding-left:40px; margin-left:auto; margin-right:auto;">
		<span style="text-align:center;">Call the Training Support Center (TSC) if you are unable to log into the system at 1.800.RED.CROSS.</span>
		</div>
		...
		<div id="login" class="login">
			...
			<header class="header" style="text-align:center;">
				<core:choose>
					<core:when test="${param.feeOption=='Scheduling'}">
						<h4>Please sign in to set up and manage Blended Learning and WSI instructor-led classes for your organization.</h4>
					</core:when>
					<core:otherwise>
						<h4>Please sign in to enter or edit course records.</h4>
					</core:otherwise>
			...
			<form:form method="POST" commandName="credentials">
				<div class="simple-form tabular-form">
					<div class="fieldset-group">
						<fieldset style="padding: 25px 25px 0px 25px;">
							...
							<div>
								<label></label>
								<div class="field">
								<a href="<core:url value="/password/reset.html"/>" tabindex="-1">Forgot Password?</a>
								</div>
							</div>
						</fieldset>
					</div>
