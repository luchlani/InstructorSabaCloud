...
<head>
	...
	<style type="text/css">
		...
		.change-div-box  {background: #FFF;position: absolute;top: 15%;left: 50%;margin: 0 0 0 -300px;padding: 0 68px;width: 500px;height: 400px;overflow-x: hidden;overflow-y: auto;}
...
<div class="left-rail content-wrap">
	<div class="content student-page">
		...
		<div  class="change-div-box corners" >
			...
			<form id="reset" action="<core:url value="/password/change.html"/>" method="POST">
				<table width="100%">
				<tr>
				<td colspan="2">
					<div style="color:#AD5E5C; padding-bottom: 20px;">${message}</div>
				</td>
				</tr>
				<tr>
				<td>
					<label for="oldpasswd" class="asterisk">Old Password:</label>
				</td>
				<td>
				...
				<tr>
				<td>
					<label for="newpasswd1" class="asterisk">New Password:</label>
				</td>
				<td>
				...
				<tr>
				<td>
					<label for="newpasswd2" class="asterisk">Confirm Password:</label>
				</td>
				<td>
				...
				<fieldset>
					...
					<div class="action plain-button alt-button" style="margin-left: 0px;">
						<div class="bw">
							<input id="close" type="button" class="button" name="close" value="Close" onclick="window.location.href='<core:url value="/authentication/login.html"/>'">	
						</div>
					</div>
					</div>
				</fieldset>
		...
		<% } else { %>
		<div id="change-div-box" class="change-div-box">
			<div style="position: relative;top: 20px;width: 100%;padding: 10px;">
			<header class="header">
				<h4>Change Password</h4>
			</header>
